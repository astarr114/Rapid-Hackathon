...
import { AgentGroundingPanel } from '../components/AgentGroundingPanel';
import { CommandCenterAgentChat } from '../components/CommandCenterAgentChat';
...
export function CommandCenterPage() {
  ...
  return (
    <>
      ...
      <div className="command-center-ai-row">
        <ExecutiveBriefingPanel
          onPromptSelect={(prompt) => setAgentSeedPrompt(prompt)}
        />
        <div className="command-center-ai-row__side">
          <CommandCenterAgentChat
            seedPrompt={agentSeedPrompt}
            onSeedConsumed={() => setAgentSeedPrompt(undefined)}
          />
          <AgentGroundingPanel />
        </div>
      </div>
      ...
      <div className="card command-center-sla">
